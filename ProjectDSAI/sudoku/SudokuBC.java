	...
	public boolean losOp(int i, int j, int[][] sudoku)
	{
		...
		for( int k = 1; k <= 9; ++k)
		{
			if(mogelijkheden(i,j,k,sudoku))
			{
				...
				System.out.printf("Backtrack met tactics\n");
				updateTo2d();
...
*/
	...
	public static void main(String[] args)
	{
		...
		System.out.printf("Hierboven het resultaat met alleen Tactics, nu de combinatie van Tactics en Backtracken.\n");
	...
	public void updateTo2d()
	{
		for(int i = 0; i < SUDOKU_LENGTH; i++)
		{
			for(int j = 0; j < SUDOKU_LENGTH; j++)
			{
				...
				{
					sudoku[i][j] = getValue(possSudoku[i][j]);
				}
			}
		}
	}
